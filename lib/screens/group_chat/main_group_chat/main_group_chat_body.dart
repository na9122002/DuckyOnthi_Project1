...
class MainGroupChatBody extends StatefulWidget {
  ...
  @override
  State<MainGroupChatBody> createState() => _MainGroupChatBodyState();
}

class _MainGroupChatBodyState extends State<MainGroupChatBody> {
                                        ...
                                        child: PopupMenuButton<SampleItem>(
                                          ...
                                          onSelected: (SampleItem item) async {
                                            ...
                                            if (snap[index]['IDUser'] ==
                                                IDUser) {
                                              _deleteQuestion(widget.docIDPost,
